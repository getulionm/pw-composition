 ...
 * floating testing widget by setting `localStorage` key **`pw-pom-visual`**
 * before each document loads. [`mock-app/shared/mock-shell.js`](../../mock-app/shared/mock-shell.js)
 * reads that key and toggles `body.pom-visual`.
 */
