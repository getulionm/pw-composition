      ...
      "boundaries/element-types": [
        "error",
        {
          ...
          rules: [
            ...
            { from: "shell", allow: ["framework", "shared", "helpers", "shell"] },
            { from: "catalog", allow: ["framework", "shared", "helpers", "shell", "catalog"] },
            { from: "cart", allow: ["framework", "shared", "helpers", "shell", "cart"] },
            {
              from: "checkout",
              allow: ["framework", "shared", "helpers", "shell", "checkout"],
            },
            {
              from: "fixtures-root",
              allow: [
